...
const ChatWidget = () => {
    ...
    // Get seller name dynamically (if available)
    const sellerName = "Seller"; // You can enhance this later
        ...
        <>
            ...
            <div className="fixed inset-0 z-[100] bg-white md:hidden">
                ...
                <div className="bg-[#8069AE] text-white p-4 flex items-center">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-full bg-white/30 flex items-center justify-center text-sm">S</div>
                        <span className="font-medium">{sellerName}</span>
                    </div>
                </div>
